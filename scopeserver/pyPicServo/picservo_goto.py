...
servo_fast_rate = int(64000*0.000512*2**16)
...
#ra_mod.ServoLoadTraj(nmccom.LOAD_PWM | nmccom.START_NOW, pwm=32)
#ra_mod.ServoLoadTraj(nmccom.LOAD_PWM | nmccom.START_NOW | nmccom.REVERSE, pwm=32)
...
# Slew at fast rate
ra_mod.ServoLoadTraj(nmccom.LOAD_POS | nmccom.LOAD_VEL | nmccom.LOAD_ACC | nmccom.ENABLE_SERVO | nmccom.START_NOW, 15*64000, servo_fast_rate, 400, 0)
...
# Slew at sidereal rate
ra_mod.ServoLoadTraj(nmccom.LOAD_POS | nmccom.LOAD_VEL | nmccom.LOAD_ACC | nmccom.ENABLE_SERVO | nmccom.START_NOW, pos + 10*40000, servo_sidereal_rate, 100, 0)
